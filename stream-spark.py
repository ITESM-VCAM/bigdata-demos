...
github_user = st.text_input('Github user', value='ITESM-VCAM')
github_repo = st.text_input('Github repo', value='bigdata-demos')
...
url_results = st.text_input(
    'URL results', value='https://raw.githubusercontent.com/...')
